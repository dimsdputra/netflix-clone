...
const request = {
    fetchTrending: `${BASE_URL}/trending/all/week?api_key=${API_KEY}&language=id-ID&region=ID`,
    fetchNetflixOriginals: `${BASE_URL}/discover/movie?api_key=${API_KEY}&with_networks=213`,
    fetchTopRated: `${BASE_URL}/movie/top_rated?api_key=${API_KEY}&language=id-ID&region=ID`,
